...
- Make knowledge file loading path-independent.
- Add unit tests for routing and node behavior.
- Replace mock lead capture with real CRM/API integration.
- Add logging and error handling around Gemini calls.